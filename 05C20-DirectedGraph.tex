...
\usepackage{pmmeta}
\pmcanonicalname{DirectedGraph}
\pmcreated{2013-03-22 12:16:18}
\pmmodified{2013-03-22 12:16:18}
\pmowner{rm50}{10146}
\pmmodifier{rm50}{10146}
\pmtitle{directed graph}
\pmrecord{12}{31702}
\pmprivacy{1}
\pmauthor{rm50}{10146}
\pmtype{Definition}
...
\pmsynonym{digraph}{DirectedGraph}
\pmsynonym{in degree}{DirectedGraph}
\pmsynonym{out degree}{DirectedGraph}
\pmrelated{Graph}
\pmrelated{VeblensTheorem}
\pmrelated{GraphTheory}
\pmdefines{in-degree}
\pmdefines{out-degree}
\pmdefines{directed spanning tree}
