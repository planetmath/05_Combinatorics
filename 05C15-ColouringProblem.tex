...
\usepackage{pmmeta}
\pmcanonicalname{ColouringProblem}
\pmcreated{2013-03-22 12:17:00}
\pmmodified{2013-03-22 12:17:00}
\pmowner{vampyr}{22}
\pmmodifier{vampyr}{22}
\pmtitle{colouring problem}
\pmrecord{7}{31758}
\pmprivacy{1}
\pmauthor{vampyr}{22}
\pmtype{Topic}
...
\pmsynonym{coloring problem}{ColouringProblem}
\pmsynonym{colour}{ColouringProblem}
\pmsynonym{color}{ColouringProblem}
\pmsynonym{graph colouring}{ColouringProblem}
\pmsynonym{graph coloring}{ColouringProblem}
